...
// CHECK-SAME:     ([[ARG:%.+]]: vector<2x3x4xi32>) -> vector<2x3x4xi32>
// CHECK-NEXT:     return [[ARG]] : vector<2x3x4xi32>
...
// CHECK-SAME:     ([[ARG:%.+]]: vector<2x4xi32>) -> vector<2x4xi32>
// CHECK-NEXT:     [[RES:%.+]] = call @identity_vector([[ARG]]) : (vector<2x4xi32>) -> vector<2x4xi32>
