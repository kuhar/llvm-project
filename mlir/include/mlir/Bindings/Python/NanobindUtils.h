...
public:
  ...
  //
  // These slots are passed via nanobind::type_slots() at class creation time,
  // which is compatible with both the full and limited (stable ABI) Python
  // APIs.
  static inline PyType_Slot sequenceSlots[] = {
